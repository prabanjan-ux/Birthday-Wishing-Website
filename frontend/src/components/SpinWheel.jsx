...
// A generic list of segments to use as a placeholder
...
export default function SpinWheel({
  ...
  subtitle = "Click the button to find out what you get!",
  segments = placeholderSegments,
  resultTitle = (segment) => `You landed on: ${segment.text}!`,
  resultContent = "Congratulations! Enjoy your result.",
}) {
  ...
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-pink-100 via-rose-200 to-pink-300 overflow-hidden text-center p-4">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-[180px] sm:-translate-y-[230px] z-10">
        <div className="w-0 h-0 border-l-[10px] border-l-transparent border-r-[10px] border-r-transparent border-t-[20px] border-t-rose-500 drop-shadow-lg" />
      </div>
      ...
      >
        <svg viewBox="0 0 200 200" className="w-full h-full drop-shadow-xl">
          {segments.map((segment, index) => {
            ...
            const colors = ["#ffc8dd", "#ffafcc", "#bde0fe", "#a2d2ff", "#ffddd2", "#ffc09f", "#ffee93", "#fcf5c7", "#d4a373", "#e9edc9"];
